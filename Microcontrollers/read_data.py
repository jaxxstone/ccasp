#!/usr/bin/env python
'''
Sends commands to Arduino master controller, receives responses, and calls Django management command
to commit new record to database
'''
import serial
import time
...
while True:
    ...
    while ser.inWaiting() > 0:
		...
		# call_comment executes a Django management command found in Receiver/management/commands
