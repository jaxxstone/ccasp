...
from Receiver.views import admin, dashboard, overview, daily_report, weekly_report, monthly_report, yearly_report, custom_form, custom_report, report_list, node_list
